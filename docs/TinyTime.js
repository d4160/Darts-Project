...
assert((6245088) % 16 === 0, 'heap must start aligned to 16 bytes, DYNAMIC_BASE==' + 6245088);
...
updateGlobalBufferAndViews(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 6245088;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=1002192;function __emscripten_get_fetch_work_queue() {
  ...
  var ___tm_current=1002048;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 1002096, 4), 1002096);function _gmtime_r(time, tmPtr) {
